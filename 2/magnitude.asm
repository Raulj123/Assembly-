...
xorpd xmm14, xmm14      ;xorpd "zeros" out an xmm register 
mov r15, rdi    ;Holds the first parameter(array_A)
mov r14, rsi    ;Holds the second parameter elements in array_A
mov r13, 0      ;For loop counter

BeginLoop:
    cmp r14,r13     ;compare counter with array elements
    je terminateLoop       ;if equal end loop
    movsd xmm15, [r15 + 8*r13]     ;place array[counter] in xmm15 
    mulsd xmm15, xmm15             ;multiply array[counter] by itself 
    addsd xmm14, xmm15             ;Add array[counter] to 0 in the first iteration  
    inc r13                        ;increment r13
    jmp BeginLoop

terminateLoop:
sqrtsd xmm14, xmm14     ;square number that you got from all the loop
movsd xmm0, xmm14
